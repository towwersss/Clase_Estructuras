...
list<char*> entrada;
    ...
    if(strcmp(comando,"help")==0){
        ...
        if(i < 2){
            ...
            advance(it, 1);
            advance(it,1);
            float indicedeconectividad;
            indicedeconectividad = atof(*it);
            Curiosity.crear_Mapa(indicedeconectividad);
            cout << "El mapa se ha creado\n";
            return;
        }
    }
        ...
        if(i < 1){
            ...
            Curiosity.ruta_mas_larga(Curiosity.mapa);
            cout << "se ha mostrado la ruta mas larga\n";
            return;
        }
    }
